...
import TaskListL from "../../Components/TaskListL";
...
export default function Livros() {
  ...
  useEffect(() => {
    async function loadTask() {
      const taskStorange = await AsyncStorage.getItem("@Livros");
  ...
  useEffect(() => {
    async function saveTask() {
      await AsyncStorage.setItem("@Livros", JSON.stringify(task));
    }
    saveTask();
  }, [task]);
  ...
  return (
    <SafeAreaView style={styles.Container}>
      ...
      <AnimatedFl
        ...
        renderItem={({ item }) => (
          <TaskListL data={item} handleDelete={handleDelete} />
        )}
      ></AnimatedFl>
